package cc.dt.hrweb.system.service.impl;

import cc.dt.hrweb.common.domain.HrWebConstant;
import cc.dt.hrweb.common.domain.QueryRequest;
import cc.dt.hrweb.common.domain.Tree;
import cc.dt.hrweb.common.utils.SortUtil;
import cc.dt.hrweb.common.utils.TreeUtil;
import cc.dt.hrweb.system.dao.DeptMapper;
...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements DeptService {
    ...
    public List<Dept> findDepts(Dept dept, QueryRequest request) {
        ...
        SortUtil.handleWrapperSort(request, queryWrapper, "orderNum", HrWebConstant.ORDER_ASC, true);
    ...
    @Override
    public List<Dept> findDeptName(Long deptId) {
        return baseMapper.selectList(new LambdaQueryWrapper<Dept>().eq(Dept::getDeptId, deptId));
    }
