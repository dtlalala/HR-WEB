...
import cc.dt.hrweb.busi.service.impl.TUserinfoServiceImpl;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public List<User> findAll() {
        return baseMapper.selectList(new LambdaQueryWrapper<User>().select(User::getUserId, User::getDeptId));
    }
    ...
    public IPage<User> findUserDetail(User user, QueryRequest request) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "userId", HrWebConstant.ORDER_ASC, false);
    ...
    public void createUser(User user) throws Exception {
        ...
        save(user);
//        User userTmp = new UserServiceImpl().findByName(user.getUsername());
        Map<String, String> map = new HashMap<String,String>();
        map.put("0","男");
        map.put("1","女");
        map.put("2","保密");
        TUserinfo tUserinfo = new TUserinfo();
        tUserinfo.setPersonnelId(user.getUserId());
        tUserinfo.setPersonnelName(user.getPersonnelName());
        tUserinfo.setPersonnelSex(map.get(user.getSsex()));
        itUserinfoService.insertPersonnel(tUserinfo);
    ...
    public void deleteUsers(String[] userIds) throws Exception {
        ...
        removeByIds(list);
        itUserinfoService.deleteByIds(list);
