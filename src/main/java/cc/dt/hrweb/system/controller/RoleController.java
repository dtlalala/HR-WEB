...
import cc.dt.hrweb.system.domain.RoleMenu;
import cc.dt.hrweb.system.service.RoleService;
import cc.dt.hrweb.system.service.RoleMenuServie;
...
public class RoleController extends BaseController {
    ...
    public void addRole(@Valid Role role) throws HrwebException {
        try {
    ...
    public void deleteRoles(@NotBlank(message = "{required}") @PathVariable String roleIds) throws HrwebException {
        try {
    ...
    public void updateRole(Role role) throws HrwebException {
        try {
    ...
    public void export(QueryRequest queryRequest, Role role, HttpServletResponse response) throws HrwebException {
        try {
