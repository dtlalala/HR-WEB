...
public class DeptController extends BaseController {
    ...
    public void addDept(@Valid Dept dept) throws HrwebException {
        try {
    ...
    public void deleteDepts(@NotBlank(message = "{required}") @PathVariable String deptIds) throws HrwebException {
        try {
    ...
    public void updateDept(@Valid Dept dept) throws HrwebException {
        try {
    ...
    public void export(Dept dept, QueryRequest request, HttpServletResponse response) throws HrwebException {
        try {
