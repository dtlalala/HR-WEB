...
public class LogController extends BaseController {
    ...
    public void deleteLogss(@NotBlank(message = "{required}") @PathVariable String ids) throws HrwebException {
        try {
    ...
    public void export(QueryRequest request, SysLog sysLog, HttpServletResponse response) throws HrwebException {
        try {
