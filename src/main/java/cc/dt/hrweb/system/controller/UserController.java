...
import cc.dt.hrweb.common.utils.MD5Util;
...
public class UserController extends BaseController {
    ...
    public void addUser(@Valid User user) throws HrwebException {
        try {
    ...
    public void updateUser(@Valid User user) throws HrwebException {
        try {
    ...
    public void deleteUsers(@NotBlank(message = "{required}") @PathVariable String userIds) throws HrwebException {
        try {
    ...
    @PutMapping("profile")
    public void updateProfile(@Valid User user) throws HrwebException {
        try {
    ...
    public void updateAvatar(
            ...
            @NotBlank(message = "{required}") String avatar) throws HrwebException {
        try {
    ...
    public void updateUserConfig(@Valid UserConfig userConfig) throws HrwebException {
        try {
    ...
    public void updatePassword(
            @NotBlank(message = "{required}") String username,
            @NotBlank(message = "{required}") String password) throws HrwebException {
        try {
    ...
    public void resetPassword(@NotBlank(message = "{required}") String usernames) throws HrwebException {
        try {
    ...
    public void export(QueryRequest queryRequest, User user, HttpServletResponse response) throws HrwebException {
        try {
