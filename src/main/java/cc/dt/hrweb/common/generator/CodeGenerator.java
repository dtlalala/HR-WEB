package cc.dt.hrweb.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/graduation_dt?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // @author 值
    private static final String AUTHOR = "dtlalala";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "cc.dt.hrweb";
    // xml文件路径
    private static final String XML_PACKAGE_URL = "/src/main/resources/mapper/busi";
    // xml 文件模板
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setModuleName("busi");
