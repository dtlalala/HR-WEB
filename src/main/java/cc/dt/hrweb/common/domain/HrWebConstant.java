 ...
 * 系统的一些常量
 */
public class HrWebConstant {

    // user缓存前缀
    public static final String USER_CACHE_PREFIX = "hrweb.cache.user.";
    // user角色缓存前缀
    public static final String USER_ROLE_CACHE_PREFIX = "hrweb.cache.user.role.";
    // user权限缓存前缀
    public static final String USER_PERMISSION_CACHE_PREFIX = "hrweb.cache.user.permission.";
    // user个性化配置前缀
    public static final String USER_CONFIG_CACHE_PREFIX = "hrweb.cache.user.config.";
    // token缓存前缀
    public static final String TOKEN_CACHE_PREFIX = "hrweb.cache.token.";

    // 存储在线用户的 zset前缀
    public static final String ACTIVE_USERS_ZSET_PREFIX = "hrweb.user.active";
