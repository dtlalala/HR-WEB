...
import cc.dt.hrweb.job.domain.JobLog;
import cc.dt.hrweb.job.service.JobLogService;
...
public class JobLogController extends BaseController {
    ...
    public void deleteJobLog(@NotBlank(message = "{required}") @PathVariable String jobIds) throws HrwebException {
        try {
    ...
    public void export(QueryRequest request, JobLog jobLog, HttpServletResponse response) throws HrwebException {
        try {
